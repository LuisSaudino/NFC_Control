...
<html>
	...
	<body>
		...
		<ul class="topnav">
			...
			<li><a class="active" href="read tag.php">Pesquisar</a></li>
		</ul>
		
		<br>
		
		<h3 align="center" id="blink">POR FAVOR ESCANEAR SEU CARTÃO NO SENSOR.</h3>
		...
		<div id="show_user_data">
			<form>
				<table  width="452" border="1" bordercolor="#10a0c5" align="center"  cellpadding="0" cellspacing="1"  bgcolor="#000" style="padding: 2px; border-radius:10px;">
					<tr>
					...
					<tr>
						<td  bgcolor="#ACBEA3"> <font color="#000000">
