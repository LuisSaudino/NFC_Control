    ...
    <header>
		...
		<div class="conteudo">
			<form class="form-horizontal" action="insertUser.php" method="post">
				<fieldset>
					<div class="card">
						<div class="card-header bg-dark text-white"><h5>Cadastrar Usuário</h5></div>
						<div class="m-3">
							<div class="form-group text-start">
								<label for="Usuario" class="control-label"><b>Usuario</label>
								<input class="form-control" type="text" name="usuario" id="" required>
							</div>
							<div class="form-group text-start">
								<label for="Usuario" class="control-label">Senha</label>
